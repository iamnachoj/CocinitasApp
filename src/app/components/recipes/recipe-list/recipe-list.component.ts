...
export class RecipeListComponent {
    ...
    @Output() recipes: Recipe[] = [
        new Recipe(
            ...
            [{name: "Waxy potatoes", amount: "300g"}, {name: "onion", amount: 1}, {name: "olive oil", amount: "enough to cover potatoes in pan"}, {name: "eggs", amount: 5}]
        ...
        new Recipe(
            ...
            [{name: "mature tomatoes", amount: "1kg"}, {name: "Long, light green pepper", amount: 1}, {name: "Half Cucumber", amount: "5 to 10cm"}, {name: "Garlic", amount: "2 cloves"}, {name: "Vinegar, oil and salt", amount: "2 spoons each, just 1 teaspoon of salt"}]
        )]
}
